...
| ID | Driver arquitectónico | Origen | Influencia |
|---|---|---|---|
...
| DA02 | El sistema debe mantener tiempos de respuesta adecuados durante una alta concurrencia. | AC01 - Rendimiento | Influye en la comunicación entre componentes, procesamiento y almacenamiento. |
...
| DA04 | El sistema debe integrarse con una pasarela de pago externa mediante una API. | RC04 - Pasarela de pago | Condiciona la integración con servicios externos. |
